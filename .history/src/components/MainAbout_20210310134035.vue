<template>
  <section class="px-8 pt-24 md:px-10 xl:p-40">
    <div class="flex flex-col md:flex-row">
      ...
      <div class="md:pl-16 text-grayBlue">
        <h2
          class="pt-16 text-4xl font-bold leading-10 tracking-tight font-ibarra"
        >
          About me
        </h2>
        <p class="leading-7 font-publicSans pt-7">
