<template>
  <section class="px-8 pt-16 md:px-10 xl:px-40">
    <div class="flex flex-col md:flex-row">
      ...
      />
      <img
        class="hidden w-64 md:block xl:hidden"
        src="../assets/images/homepage/tablet/image-homepage-profile@2x.jpg"
      />

      <img
        class="hidden w-96 xl:block"
        src="../assets/images/homepage/desktop/image-homepage-profile@2x.jpg"
      />

      <div class="md:pl-16 xl:pl-32 text-grayBlue">
        <h2
          class="pt-16 text-4xl font-bold leading-10 tracking-tight text-grayBlue font-ibarra"
        >
          About me
        </h2>
        ...
        <div class="pt-6">
          <base-button buttonType="primary">Primary</base-button><br />
          <br />
          <base-button buttonType="secondary">Secondary</base-button>
        </div>
      </div>
    </div>
  </section>
